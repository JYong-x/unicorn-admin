 ...
 * 教师教学档案
 */
const subUrl = '/tpms/portal'
const routerMap = [
  {
    path: subUrl + '/home?methodToCall=getTPMSHomePage&viewId=PortalView',
    name: 'tpmsHome',
    x: 1,
    y: 1,
  ...
  {
    path: subUrl + '/class?methodToCall=getMyPortfolio&amp;viewId=PortfolioView',
    name: 'PersonalCourse',
    x: 1,
    y: 2,
    icon: 'icon-xuejiguanli1',
  ...
  {
    path: subUrl + '/portfolio?methodToCall=getAdminPerformanceQueryPage&amp;viewId=PortfolioView',
  ...
  {
    path: subUrl + '/class?methodToCall=getCourseInfoConfirmAndReportErrorPage&amp;viewId=ReviewView',
  ...
  {
    path: subUrl + '/portfolio?methodToCall=getReviewConsolePage&amp;viewId=ReviewView',
    name: 'ReviewConsole',
    x: 2,
    y: 1,
    icon: 'icon-xuqiupingshen',
  ...
  {
    path: subUrl + '/achievement?methodToCall=getEduTeachingAchvPage&amp;viewId=ReviewView',
  ...
  {
    path: subUrl + '/class?methodToCall=getManageClassAttendancePage&amp;viewId=PortfolioView',
    name: 'AchievementReviewBlock',
    x: 2,
    y: 4,
    icon: 'icon-tongji1',
  ...
  {
    path: subUrl + '/class?methodToCall=getInstructorClassAttendancePage&amp;viewId=PortfolioView',
    name: 'AchievementReviewBlock',
    x: 2,
    y: 5,
    icon: 'icon-zhidaobiaozhun',
  ...
  {
    path: subUrl + '/statistics?methodToCall=getPgBInfoPage&amp;viewId=StatisticView',
  ...
  {
    path: subUrl + '/statistics?methodToCall=getAllowanceDetailsPage&amp;viewId=StatisticView',
  ...
  {
    path: subUrl + '/statistics?methodToCall=getBDataImportPage&amp;viewId=StatisticView',
    name: 'DataImport',
    x: 3,
    y: 3,
    icon: 'icon-xuqiupingshen',
  ...
  {
    path: subUrl + '/admin?methodToCall=getCourseLabelManagePage&amp;viewId=AdminView',
  ...
  {
    path: subUrl + '/admin?methodToCall=getRuleConsole&amp;viewId=AdminView',
  ...
  {
    path: subUrl + '/admin?methodToCall=getJournalLibPage&amp;viewId=AdminView',
    name: 'JournalLibrary',
    x: 4,
    y: 10,
    icon: 'icon-xuqiupingshen',
